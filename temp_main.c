...
/*energy difference for each prospective spin flip 
...
void evolve(int present[N][N]){
    ...
    while(k>0){      //time steps
         ...
         if( ediff < 0 ||  genrand_real1() < expl(-ediff/T))  //spin-flipping with a probability using boltzaman factor
